...
<div class="row g-2 align-items-end">
    <div class="col-md-3"><label class="form-label">Module</label><input type="text" name="log_module" class="form-control" placeholder="e.g. employees" value="<?=e(get('log_module'))?>"></div>
...
<?=paginationLinks($pg,'index.php?module=audit&log_module='.get('log_module').'&date_from='.get('date_from').'&date_to='.get('date_to'))?>
</div>
<?php endif;?>
</div></div>
